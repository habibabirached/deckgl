  ...
  for (var key in oldProps) {
    if (!(key in ignoreProps)) {
      ...
      if (equal && !equal(newProp, oldProp, propType)) {
        return "".concat(triggerName, ".").concat(key, " changed deeply: ").concat(oldProp, " -> ").concat(newProp);
      }
      ...
      if (!equal && oldProp !== newProp) {
        return "".concat(triggerName, ".").concat(key, " changed shallowly: ").concat(oldProp, " -> ").concat(newProp);
      }
    }
