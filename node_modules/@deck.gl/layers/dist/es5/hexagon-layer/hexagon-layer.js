...
function (_CompositeLayer) {
  ...
  function HexagonLayer(props) {
    ...
    if (!props.hexagonAggregator && !props.radius) {
      _core.log.once(0, 'HexagonLayer: Default hexagonAggregator requires radius prop to be set, ' + 'Now using 1000 meter as default')();
    ...
    if (Number.isFinite(props.upperPercentile) && (props.upperPercentile > 100 || props.upperPercentile < 0)) {
      _core.log.once(0, 'HexagonLayer: upperPercentile should be between 0 and 100. ' + 'Assign to 100 by default')();
    ...
    if (Number.isFinite(props.lowerPercentile) && (props.lowerPercentile > 100 || props.lowerPercentile < 0)) {
      _core.log.once(0, 'HexagonLayer: lowerPercentile should be between 0 and 100. ' + 'Assign to 0 by default')();

      props.lowerPercentile = defaultProps.upperPercentile.value;
    }

    if (props.lowerPercentile >= props.upperPercentile) {
      _core.log.once(0, 'HexagonLayer: lowerPercentile should not be bigger than ' + 'upperPercentile. Assign to 0 by default')();

      props.lowerPercentile = defaultProps.lowerPercentile.value;
    }

    return _possibleConstructorReturn(this, _getPrototypeOf(HexagonLayer).call(this, props));
  }
  ...
  _createClass(HexagonLayer, [{
    ...
    value: function getSubLayerProps() {
      ...
      return _get(_getPrototypeOf(HexagonLayer.prototype), "getSubLayerProps", this).call(this, {
        id: 'hexagon-cell',
