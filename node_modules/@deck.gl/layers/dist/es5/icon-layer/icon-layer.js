  ...
  _createClass(IconLayer, [{
      ...
      if (oldProps.iconAtlas !== iconAtlas) {
        if (iconAtlas instanceof _luma.Texture2D) {
          ...
          (0, _luma.loadTextures)(this.context.gl, {
            ...
            texture.setParameters((_texture$setParameter = {}, _defineProperty(_texture$setParameter, _constants.default.TEXTURE_MIN_FILTER, DEFAULT_TEXTURE_MIN_FILTER), _defineProperty(_texture$setParameter, _constants.default.TEXTURE_MAG_FILTER, DEFAULT_TEXTURE_MAG_FILTER), _texture$setParameter));
    ...
    value: function calculateInstanceColorMode(attribute) {
      var _this$props3 = this.props,
          ...
          iconMapping = _this$props3.iconMapping,
          getIcon = _this$props3.getIcon;
      var value = attribute.value;
      var i = 0;
    ...
    value: function calculateInstanceIconFrames(attribute) {
      var _this$props4 = this.props,
          ...
          iconMapping = _this$props4.iconMapping,
          getIcon = _this$props4.getIcon;
      var value = attribute.value;
      var i = 0;
