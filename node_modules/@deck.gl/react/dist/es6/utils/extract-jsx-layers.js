...
import { Layer, View } from '@deck.gl/core'; // recursively wrap render callbacks in `View`
...
function createLayer(LayerType, reactProps) {
  const props = {}; // Layer.defaultProps is treated as ReactElement.defaultProps and merged into react props
  // Remove them
