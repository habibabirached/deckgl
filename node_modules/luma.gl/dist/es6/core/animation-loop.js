...
export default class AnimationLoop {
  ...
  start(opts = {}) {
    ...
    if (!this._animationFrameId) {
      ...
      this._startPromise = getPageLoadPromise().then(() => {
        ...
        this._startEventHandling(); // Initialize the callback data


        this._initializeCallbackData();

        this._updateCallbackData(); // Default viewport setup, in case onInitialize wants to render


        this._resizeCanvasDrawingBuffer();

        this._resizeViewport(); // Note: onIntialize can return a promise (in case it needs to load resources)
  ...
  _getSizeAndAspect() {
    ...
    const height = this.gl.drawingBufferHeight; // https://webglfundamentals.org/webgl/lessons/webgl-anti-patterns.html
