...
const LOG_PROGRAM_PERF_PRIORITY = 4; // const GL_INTERLEAVED_ATTRIBS = 0x8C8C;
...
export default class Program extends Resource {
  ...
  _compileAndLink() {
    ...
    log.timeEnd(LOG_PROGRAM_PERF_PRIORITY, `linkProgram for ${this._getName()}`)(); // Avoid checking program linking error in production
