...
const NPOT_MIN_FILTERS = [9729, 9728]; // const S3TC = 'WEBGL_compressed_texture_s3tc';
  ...
  setSubImageData({
    ...
    withParameters(this.gl, parameters, () => {
      ...
      if (compressed) {
        ...
        assertWebGL2Context(this.gl); // This texImage2D signature uses currently bound GL.PIXEL_UNPACK_BUFFER
